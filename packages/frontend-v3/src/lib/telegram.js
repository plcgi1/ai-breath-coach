...
export function initTelegram() {
  ...
  // Установка цветов для соответствия вашему дизайну Nebula
  tg.setHeaderColor('#1e1b4b'); // Темно-синий верх
  tg.setBackgroundColor('#020617'); // Ультрамариновый фон [cite: 51]
